        ...
        <div className="flex flex-col max-w-[1400px] w-full">
          ...
          <div className="grid grid-cols-2 gap-[20px] mt-[40px]">
            <FeatureCard
              ...
              description="Клікни на компонент у Figma — плагін миттєво зчитає параметри прямо з ноди і сформує структурований опис без жодного введення вручну."
            />
            <FeatureCard
              icon={<FileCheckIcon />}
            ...
            <FeatureCard
              icon={<UserCheckIcon />}
              title="Специфікація одразу перед очима"
              description="Результат з'являється прямо в панелі плагіна — переглянь, скопіюй як Markdown і використай у документації без зайвих кроків."
            />
          </div>
        </div>
      </div>
