          ...
          <div className="flex flex-col max-w-[640px]">
            ...
            <div className="mt-[40px] border-l-2 border-brand pl-[20px] flex flex-col">
              ...
              <p className="font-inter font-normal text-[14px] leading-[25px] text-fg2 mt-[20px] max-w-[618px]">
                AI Specs перетворює Figma-ноду компонента на структуровану специфікацію за лічені хвилини. AI пропонує варіант — ти переглядаєш, коригуєш і затверджуєш. Жодних припущень без твоєї перевірки.
              </p>
            </div>
          </div>
